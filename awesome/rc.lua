...
globalkeys = awful.util.table.join(
   ...
   awful.key({ }, "XF86AudioRaiseVolume", function ()
       awful.util.spawn("amixer -c 1 set Master 9%+") end),
   awful.key({ }, "XF86AudioLowerVolume", function ()
       awful.util.spawn("amixer -c 1 set Master 9%-") end),
  -- awful.key({ }, "XF86AudioMute", function ()
    --   awful.util.spawn("amixer -c 1 sset Master toggle") end),
...
awful.key({ modkey, "Shift" }, "Left" ,
          function ()
              if client.focus then
                  local idx = awful.tag.getidx(client.focus.tag)
                  local tag = awful.tag.gettags(client.focus.screen)[idx - 1]
                  if tag then
